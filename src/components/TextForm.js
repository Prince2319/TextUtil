...
export default function TextForm(props) {
    ...
    return (
        ...
        <div className = "container" style={{color: props.mode === 'dark' ? 'white':'#042743'}}>
            ...
            <div className="mb-3">
            <textarea className="form-control" value = {text} onChange = {handleOnChange}  style={{backgroundColor: props.mode === 'dark' ? '#223f6b':'white' , color: props.mode === 'dark' ? 'white':'#042743'}} id="myBox" rows="8"></textarea>
            </div>
